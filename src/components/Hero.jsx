  ...
  return (
    <section className='relative bg-hero bg-cover bg-center bg-no-repeat h-screen w-full '>
        <div className='max_padd_container relative top-32 xs:top-52'>
            <h1 className='h1 capitalize max-w-[37rem] '>Dress Pallette Shopping Hub</h1>
            <p className='text-gray-50 regular-16 mt-6 max-w-[33rem]'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Autem laborum voluptas vitae eaque, ratione officia? Dicta quas laboriosam qui atque quam, itaque quis nulla architecto, a, consequatur eius voluptate. Dignissimos, eos. Laborum, facere.</p>
