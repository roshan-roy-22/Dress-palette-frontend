    ...
    <section className="max_padd_container pt-28">
      <table className="w-full mx-auto">
        ...
        <tbody>
          {allProducts.map((e) => {
            if (cartItems[e.id] > 0) {
              return <tr className="border-b border-slate-900/20 p-6 medium-14 text-center text-grey-30" key={e.id}>
                <td className="flexCenter"><img className="rounded-lg ring-1 ring-slate-900/5 my-1" src={e.image} alt="prdctImg"  height={43} width={43}/></td>
        ...
        <div className="flex flex-col gap-10 ">
            ...
            <div>
                ...
                <div className="flexBetween py-4">
                    ...
                    <h4 className="medium-16">${getTotalCartAmount()}</h4>
                </div>
            </div>
            <button className="btn_dark_rounded w-44">Checkout</button>
            <div className="flex flex-col gap-10 ">
                <h4 className="bold-20 capitalize">Enter your coupen code here:</h4>
                <div className="flexBetween pl-5 h-12 bg-primary rounded-full ring-1 ring-slate-900/10">
                    <input className="bg-transparent border-none outline-none " type="text" placeholder="coupen code"/>
